"""
This script performs the model training on the abstract dataset using the pretrained robera model with a classifier head. It finetunes the roberta while training for the classification task.
...
PATH = "./transformer_model_roberta/"
